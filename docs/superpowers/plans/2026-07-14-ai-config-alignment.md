...
- [x] **Step 1: Back up both regeneration targets**
...
- [x] **Step 4: Verify sections and containment**
...
- [x] **Step 1: Probe whether a coverage driver exists (decides file content)**
...
- [x] **Step 3: Verify every documented command executes**
...
- [x] **Step 2: Verify rules match the arch tests**
...
- [x] **Step 1: Edit multi-tenancy.md**
...
- [x] **Step 2: Edit decision-guide.md**
...
- [x] **Step 2: Apply edits to the hand-written section**
...
- [x] **Step 1: Run every documented command**
...
- [x] **Step 2: Boost functional check**
...
- [x] **Step 3: Blueprint functional check**
...
- [x] **Step 4: Terminology + containment final gate**
...
- [x] **Step 5: Commit plan checkboxes + report**
