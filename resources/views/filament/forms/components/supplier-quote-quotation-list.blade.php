@php
    /** @var \App\Models\SupplierQuote $record */
    $record = $getRecord();
    ...
    $mediaItems = $record?->getMedia('quotation') ?? collect();
@endphp
        ...
        @foreach($mediaItems as $media)
            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div class="flex items-center space-x-2">
                    <a
                        href="{{ route('supplier-quotes.quotation.download', ['supplierQuote' => $record->id, 'media' => $media->id]) }}"
                        target="_blank"
                    ...
                    <button
                        ...
                        onclick="
                            if (confirm('Are you sure you want to delete this file?')) {
                                fetch('{{ route('supplier-quotes.quotation.delete', ['supplierQuote' => $record->id, 'media' => $media->id]) }}', {
                                    method: 'DELETE',
                                    headers: {
...
@else
    <p class="text-sm text-gray-500 dark:text-gray-400">No quotation uploaded yet.</p>
@endif
