...
<head>
    ...
    <title>Quotation Evaluation Approval Required: {{ $quotationEvaluation->qe_number }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px;">
                            ...
                            <div style="font-size: 14px; color: #374151; line-height: 1.8; margin-bottom: 20px;">
                                A Quotation Evaluation requires your approval before proceeding to the next stage.
                            </div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f9fafb; border-radius: 6px; padding: 20px; margin-bottom: 25px;">
                                <tr>
                                    <td>
                                        <div style="font-size: 14px; font-weight: 600; color: #1f2937; margin-bottom: 12px;">Quotation Evaluation Details:</div>
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="padding: 4px 0; font-size: 13px; color: #6b7280;">QE Number:</td>
                                                <td style="padding: 4px 0; font-size: 13px; color: #1f2937; font-weight: 500;">{{ $quotationEvaluation->qe_number }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 4px 0; font-size: 13px; color: #6b7280;">Request:</td>
                                                <td style="padding: 4px 0; font-size: 13px; color: #1f2937; font-weight: 500;">{{ $quotationEvaluation->request->request_number ?? 'N/A' }}</td>
                                            </tr>
                                            @if($quotationEvaluation->description)
                                            <tr>
                                                <td style="padding: 4px 0; font-size: 13px; color: #6b7280;">Description:</td>
                                                <td style="padding: 4px 0; font-size: 13px; color: #1f2937; font-weight: 500;">{{ $quotationEvaluation->description }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                                <td style="padding: 4px 0; font-size: 13px; color: #6b7280;">QE Date:</td>
                                                <td style="padding: 4px 0; font-size: 13px; color: #1f2937; font-weight: 500;">{{ $quotationEvaluation->qe_date->format('M j, Y') }}</td>
                                            </tr>
                                            @if($quotationEvaluation->preparedBy)
                                            <tr>
                                                <td style="padding: 4px 0; font-size: 13px; color: #6b7280;">Prepared By:</td>
                                                <td style="padding: 4px 0; font-size: 13px; color: #1f2937; font-weight: 500;">{{ $quotationEvaluation->preparedBy->name }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                                <td style="padding: 4px 0; font-size: 13px; color: #6b7280;">Status:</td>
                                                <td style="padding: 4px 0; font-size: 13px; color: #1f2937; font-weight: 500;">{{ $quotationEvaluation->status->getLabel() }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <div style="font-size: 14px; color: #374151; line-height: 1.8; margin-bottom: 25px;">
                                This Quotation Evaluation requires approval from assigned approvers: <strong>Dept Head of Sales</strong>, <strong>Deputy Director</strong>, and <strong>Director</strong>.
                            </div>
