 ...
 */
final class SupplierQuoteItemFactory extends Factory
{
     ...
     */
    public function forSupplierQuote(?SupplierQuote $supplierQuote = null): static
    {
        return $this->state(fn (array $attributes): array => [
            'supplier_quote_id' => $supplierQuote ?? SupplierQuote::factory(),
        ]);
    }
