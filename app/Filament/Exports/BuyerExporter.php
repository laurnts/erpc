...
final class BuyerExporter extends BaseExporter
{
    ...
    {
        $body = 'Your buyers export has completed and '.number_format($export->successful_rows).' '.str('row')->plural($export->successful_rows).' exported.';
