...
final class SupplierImporter extends BaseImporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ImportColumn::make('name')
                ->requiredMapping()
                ->guess(['name', 'company_name', 'supplier'])
    ...
    {
        $body = 'Your suppliers import has completed and '.Number::format($import->successful_rows).' '.str('row')->plural($import->successful_rows).' imported.';
