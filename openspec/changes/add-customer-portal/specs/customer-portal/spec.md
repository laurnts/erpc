...
The system SHALL link authenticated users to buyer companies via portal access records, scoped to a trading team.
...
- **AND** a `company_portal_users` record is created with `is_active = true`
